...
" class="pagination">';
    for ($k = 1; $k <= $all_count / 100; $k++) {
        echo '<a style="padding: 5px 10px;border: none;" href="https://morealti.com/cut/?page='.$k.'">'.$k.'</a>';
    }
echo '</div>';
echo '<div>Страница - '.$page.'</div>';

sleep(10);
if ($page <= $all_count / 100) echo "<script>document.location.href='https://morealti.com/cut/?page=".($page)."';</script>";
