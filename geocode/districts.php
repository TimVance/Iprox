    ...
    if (!empty($microdistrict)) {
        if (empty($property["microdistrict"])) {
            ...
            if (!empty($arMicroDistric["ID"])) {
                ...
                $PROP = array();
                if (!empty($arDistric["ID"])) $PROP[198] = $arDistric["ID"];
...
sleep(10);
if ($page < $all_count / 100) echo "<script>document.location.href='https://iprox.ru/geocode/districts.php';</script>";
