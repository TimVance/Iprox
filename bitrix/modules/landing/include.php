...
$jsConfig = array(
	...
	'landing_public' => [
		...
		'rel' => ['landing_event_tracker', 'mediaplayer', 'polyfill'],
	],
...
//			$pathCSS . '/landing_core.css',
		...
		'rel' => array('mediaplayer', 'landing_icon_fonts', 'main.polyfill.intersectionobserver'),
	),
	
	'landing_critical_grid' => [
		'css' => [
			$pathTemplate24 . '/assets/vendor/bootstrap/bootstrap-grid.css',
		],
//		'js' => [
//			$pathTemplate24 . '/assets/vendor/jquery/jquery-3.2.1.js',
//			$pathTemplate24 . '/assets/vendor/bootstrap/js/dist/util.js',
