...
class iProfile
{
    ...
    public function reg()
    {
        ...
        if (!empty($arResult["PARAMETERS"])) {
            ...
            if ($data == "Пользователь успешно добавлен") Response::iShowResult($data, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
            else Response::iNoResultReg($data, "Error");
        }
    ...
    public function update()
    {
        ...
        if (!empty($arResult["PARAMETERS"])) {
            ...
            if ($data == "Данные пользователя успешно обновлены") Response::iShowResult($data, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
            else Response::iNoResultReg($data, "Error");
        }
        else Response::iBadRequest();
    }
