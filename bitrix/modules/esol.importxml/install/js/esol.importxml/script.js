...
var EIXPreview = {
	...
	SetFieldValue: function(valObj, option, num, extraparams)
	{
		...
		if((typeof option == 'object') && option.value)
		{
			...
			else
			{
				...
				$('.esol_ix_str_value_close', span).bind('contextmenu', function(e){return obj.DeleteFieldContext(e, this);});
	...
	DeleteFieldContext: function(e, linkObj)
	{
		...
		if(span.length==0)
		{
			...
			var menuItems = [
				{TEXT: BX.message("ESOL_IX_DELETE_FIELD"), ONCLICK: 'EIXPreview.ContextFieldValueAction("delete")'},
				{TEXT: BX.message("ESOL_IX_CUT_FIELD"), ONCLICK: 'EIXPreview.ContextFieldValueAction("cut")'},
				{TEXT: BX.message("ESOL_IX_COPY_FIELD"), ONCLICK: 'EIXPreview.ContextFieldValueAction("copy")'}
			];
