...
<div id="report-analytics-page" class="report-analytics-page-wrapper">
	...
	<div class="report-analytics-content">
		...
		elseif ($arResult['IS_LIMITED'])
		{
			$APPLICATION->IncludeComponent(
				$arResult['ANALYTIC_BOARD_LIMIT_COMPONENT_NAME'],
				$arResult['ANALYTIC_BOARD_LIMIT_COMPONENT_TEMPLATE_NAME'],
				$arResult['ANALYTIC_BOARD_LIMIT_COMPONENT_PARAMS']
			);
		}
		else
		{
