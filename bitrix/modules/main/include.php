...
/*ZDUyZmZYmZmM2Q1ZTg2OWY1NGFmNjk5NTAwNjRmMTAwMzYzNTA=*/$GLOBALS['____1644010587']= array(base64_decode('ZG'.'V'.'ma'.'W5l'));if(!function_exists(__NAMESPACE__.'\\___307332359')){function ___307332359($_1922644878){static $_383222363= false; if($_383222363 == false) $_383222363=array('RU5DT'.'0R'.'F',''.'WQ'.'==');return base64_decode($_383222363[$_1922644878]);}};class CBXFeatures{ public static function IsFeatureEnabled($_199242684){ return true;} public static function IsFeatureEditable($_199242684){ return true;} public static function SetFeatureEnabled($_199242684, $_1798879953= true){} public static function SaveFeaturesSettings($_93835609, $_1587413183){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_2137844435){} public static function ModifyFeaturesSettings($_2137844435, $_1450173845){} public static function IsFeatureInstalled($_199242684){ return true;}} $GLOBALS['____1644010587'][0](___307332359(0), ___307332359(1));/**/			//Do not remove this
