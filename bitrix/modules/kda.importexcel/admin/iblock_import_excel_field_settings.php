		...
		<?if($bStoreList){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					...
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsex($val)?>" size="3" placeholder=";">
				</td>
			</tr>
		...
		<?if($bVideo){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					...
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?echo $fName;?>" value="<?echo htmlspecialcharsex($val)?>" placeholder="400">
				</td>
			</tr>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					...
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?echo $fName;?>" value="<?echo htmlspecialcharsex($val)?>" placeholder="300">
				</td>
			</tr>
		<?}?>
