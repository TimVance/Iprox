...
<?endif?>
	...
	<?endif?>
		...
		<?if ($arResult["STORE_PASSWORD"] == "Y"):?>
			<noindex class="restore-pass">
				<p >
					<div class="custom-check-wrap-blue check-wrap">
					<input type="checkbox" class="custom-check" id="USER_REMEMBER" name="USER_REMEMBER" value="Y" />
					</div>
	...
	<?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
			<noindex>
				<p>
				<a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a><br>
				<? 
				$StringText = GetMessage("AUTH_FIRST_ONE");
				$StringText = str_replace("#link_start#", '<a href="'.$arResult["AUTH_REGISTER_URL"].'" rel="nofollow">', $StringText);
				$StringText = str_replace("#link_end#", '</a>', $StringText);
				?><?=$StringText?>
				</p>
			</noindex>
	<?endif?>
