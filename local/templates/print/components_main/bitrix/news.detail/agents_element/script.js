$(document).ready(function(){
	...
	function bindAjax()
	{
		$(".agents_objects_wrapper .pages a").unbind("click").bind("click", function(e){
	...
	function getParamsForFilter()
	{
		...
		$return.push({name : "TYPE_BUILD", value : $(".select_build-type select").val()});
	...
	$(".agent_objects_workarea .select_build-type select").bind("change",function(){
