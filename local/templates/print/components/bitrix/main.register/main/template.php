	...
	<div class="pad-empty">
		<div class="block-regist tabs-tb">
			<div class="nav-regist nav-tb">
				<ul>
					<li id="owner"><a href="#">Владелец недвижимости</a></li>
					<li id="realtor"><a href="#">Риелтор</a></li>
				</ul>
			</div><!--nav-regist-->
				...
				<div class="body-regist">
									...
									<div class="data-left">
										...
										<div class="bl-regist">
											<div class="field-pass">
												<label>Имя:</label>
												<input type="text" name="REGISTER[NAME]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->

											<div class="field-pass">
												<label>Отчество:</label>
												<input type="text" name="REGISTER[SECOND_NAME]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->

											<div class="field-pass">
												<label>Фамилия:</label>
												<input type="text" name="REGISTER[LAST_NAME]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->
											...
											<div class="field-pass">
												<label>Телефон:</label>
												<input type="text" name="REGISTER[PERSONAL_MOBILE]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->

											<div class="field-pass">
												<label>E-mail:*</label>
												<input type="text" class="req" name="REGISTER[EMAIL]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->
									...
									<div class="data-right">
										...
										<div class="bl-regist">
											<div class="field-pass field-pass5">
												<label>Логин:*</label>
												<input type="text" class="req" name="REGISTER[LOGIN]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->

											<div class="field-pass field-pass5">
												<label>Пароль:*</label>
												<input type="password" class="req" name="REGISTER[PASSWORD]" autocomplete="off" class="bx-auth-input" />
											</div><!--field-pass-->

											<div class="field-pass field-pass5">
												<label>Повторите пароль:*</label>
												<input type="password" class="req" name="REGISTER[CONFIRM_PASSWORD]"  autocomplete="off" />
											</div><!--field-pass-->
										</div><!--bl-regist-->
									</div><!--data-right-->
								</div><!--data-->
					...
					<div class="tab-regist tab-tb">
						<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
								...
								<div class="data-left">
									...
									<div class="bl-regist">
										...
										<div class="field-pass">
											<label>Город:*</label>
											<div class="sel-on sel-on4">
												<select name="UF_CITY" class="req"  onchange="this.form.elements['REGISTER[PERSONAL_CITY]'].disabled=(this.value != 'N')">
													<option value="13">Сочи</option>
												</select>
											</div>
										</div><!--field-pass-->
										...
										<div class="assest-inp assest-inp2 customP">
											<input id="assest" checked type="checkbox" name="UF_DISPLAY_PRIVATE"/>
											<label for="assest">Не показывать на сайте</label>
										</div>
									</div><!--bl-regist-->
								</div><!--data-left-->
							...
							<div class="assest-inp assest-inp3 customP">
								<input id="assest2" class="req" checked type="checkbox" name="UF_DISPLAY_PRIVATE"/>
								<label for="assest2">Я прочитал и принимаю <a href="#">правила публикации</a> объявлений</label>
							</div>

							<div class="but-pop but-pop5">
								<input type="hidden" name="PERSONAL_PROFESSION" value="8">
								<input type="submit" name="register_submit_button" value="Зарегистрироваться" />
							</div>
						</div><!--tab-regist-->
					</form>
