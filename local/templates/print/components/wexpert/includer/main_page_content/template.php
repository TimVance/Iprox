...
<div class="wr-top">
	<div class="block-top">
		<div class="tabs-func tabs-tb">
			<? $APPLICATION->IncludeComponent('wexpert:includer', 'main_page_search_form') ?>
		</div><!--tabs-func-->
