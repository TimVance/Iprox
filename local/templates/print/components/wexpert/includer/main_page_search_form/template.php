...
<div class="cont-func cont-tb">
	<div class="tab-f tab-tb">
		<div class="tabs-room">
				...
				<div class="tab-room">
					<div class="choice-rooms">
						<div class="radio-rooms">
							<ul>
								<li class="defaultP">
									<input id="num-rooms1" data-rooms="1" checked name="num-rooms" type="radio" />
			...
			<div class="bot-forms">
				...
				<div class="view-map"><a href="#">Показать на карте</a></div><!--view-map-->
	...
	<div class="tab-f tab-tb" style="display:none">
		<div class="tabs-room">
			...
			<div class="bot-forms">
				<div class="but-choice"><button type="submit">Подобрать</button></div>
				<div class="view-map"><a href="#">Показать на карте</a></div><!--view-map-->
				<div class="more-params"><a href="#">Дополнительные параметры</a></div>
			</div><!--bot-forms-->
		</div><!--tabs-room-->
	</div><!--tab-f-->
</div><!--cont-func-->