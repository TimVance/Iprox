	...
	<ul>
		...
		foreach ($arResult['ITEMS'] as $item) {
			...
			<li>
				...
				<p class="card_notifyer">
					<small>
					Стоимость за один пакет
					</small>
				</p>
			...
			<?$this->SetViewTarget('PACKAGES_DETAIL_POP');?>
				<div id="pop<?=$item['ID']?>" class="pop pop3">
					...
					<div class="count-wrapper">
						<label>Укажите количество пакетов</label>
						<p class="pay_packet_input_wrapper_"><input class="objects_val" data-ele="<?=$item["ID"]?>" value="1" type="text"><span>шт.</span></p>
					</div>
